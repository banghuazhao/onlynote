...
class _$FolderImpl implements _Folder {
  const _$FolderImpl({required this.id, required this.name, this.sortOrder});
  ...
  @override
  String toString() {
    return 'Folder(id: $id, name: $name, sortOrder: $sortOrder)';
  }
...
abstract class _Folder implements Folder {
  const factory _Folder(
      ...
      final int? sortOrder}) = _$FolderImpl;
